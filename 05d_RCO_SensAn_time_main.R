...
#      5d: time-varying pdt technology for multi-utilities (05d_RCO_SensAn_time_main.R) | this file
...
#
# -----------------------------------------------------------------------------------------------
# content: This program repeats the analysis for the 'multi-utilities' sample but includes a 
...
# Basic model with interactions in organisational variables (multi-utilities)
# ---------------------------------------------------------------------------
