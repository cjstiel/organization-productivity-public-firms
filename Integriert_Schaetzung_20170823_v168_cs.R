...
### 
### Dateiname des Programmcodes: Integriert_Schaetzung_20170823_v168_cs.R
### erstellt: 23.08.2017
### von: Caroline Stiel
...
####################################################################################################
###
### Version 168: - Formulierung mit Translog-Modell | Wagebill | Disaggregierte Daten
###              - reine Erzeuger (Wärme/Strom) 2003-2014
###              - Grundmodell mit SE
###		 - Korrektur der Output-Elastizitäten
###		 - r_se raus
###		 - Regress Pty mit log(omega)
###		 - NOCH NICHT AM FDZ GELAUFEN
#############################  Start Analyse #######################################################
...
AR1_expost <- plm(omega2 ~ lag_omega2 + I(lag_omega2^2) + I(lag_omega2^3)
                 + lag1_eigentuemer2 
                 + shareF + shareFEW,data=data_gmm,model="pooling"
                    ,effect="time")
summary(AR1_expost)
...
###########################################
##  6.2.1 Regression mit Zeittrend       ##
###########################################
