...
#      5a: excludes gas utilities (05a_RCO_SensAn_wo_gas.R) | this file
...
#
# -----------------------------------------------------------------------------------------------
# content: This program repeats the analysis for the 'electricity and gas' sample but excludes 
# pure gas firms (see Section A.3.1 in the supplementary material online).
# version: 172
#================================================================================================
...
# Define electricity and gas sample: sensitivity analysis without gas firms
# -------------------------------------------------------------------------
# exclude pure gas utilities.
